...
function updateTrigger(key){
  ...
  if(!key){label.textContent=lang()==='en'?'Choose strategy':'Pilih strategy';meta.textContent='1Y · 5Y · 10Y';if(icon)icon.innerHTML='<svg viewBox="0 0 24 24"><path d="M5 18V9m5 9V5m5 13v-6m4 6V8" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>';return;}
